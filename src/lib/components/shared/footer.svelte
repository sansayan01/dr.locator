<footer class="border-t">
	<div class="mt-10 flex flex-col items-start gap-4 justify-between md:flex-row">
		<div class="flex flex-col gap-2 w-full justify-center items-center md:justify-start md:items-start">
			...
			<div>
				<p class="text-md font-semibold text-gray-500">123 Main St, Anytown USA 12345</p>
			</div>
		</div>
		<div class="w-full">
			<ul class="flex flex-row items-center justify-center md:justify-end gap-4  w-full">
				<li>
					<svg
						height="24"
	...
	<div class="my-10 w-full text-center">
		<p class="text-md font-semibold">&copy 2024 Aragya Inc. All rights reserved.</p>
	</div>
</footer>
